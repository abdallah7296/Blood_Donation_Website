...
namespace DAL.Migrations
{
    ...
    [Migration("20240617140720_applicationUserKey")]
    partial class applicationUserKey
    {
            ...
            modelBuilder.Entity("DAL.Entities.Donor", b =>
                {
                    b.HasOne("DAL.Entities.ApplicationUser", "User")
                        ...
                        .HasPrincipalKey("DAL.Entities.ApplicationUser", "key")
            ...
            modelBuilder.Entity("DAL.Entities.Hospital", b =>
                {
                    b.HasOne("DAL.Entities.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("DAL.Entities.Hospital", "UserId")
                        .HasPrincipalKey("DAL.Entities.ApplicationUser", "key")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
