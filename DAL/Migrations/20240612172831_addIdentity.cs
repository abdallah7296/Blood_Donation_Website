    ...
    public partial class addIdentity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FollowUpForms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FollowUpForms_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_FollowUpForms_Requests_RequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FollowUpForms_RequestId",
                table: "FollowUpForms",
                column: "RequestId");

            migrationBuilder.CreateIndex(
                name: "IX_FollowUpForms_UserId",
                table: "FollowUpForms",
                column: "UserId");
